 ...
 * @returns {Object}
 */
export default function parsePerformances(performancesData, filterVenue=false) {
    try {
        ...
        for (const performance of performanceData) {
            ...
            performance.StartString = String(performance.Start.getHours()).padStart(2, '0')+':'+String(performance.Start.getMinutes()).padStart(2, '0');
