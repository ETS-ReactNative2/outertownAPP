            ...
            <View style={baseStyles.contentContainer}>
                ...
                <View style={baseStyles.textContainer}>
                    <Text style={baseStyles.stdText}>
                        ...
                        This is app is built with Expo, and that tool may request your Android Advertising ID, though this code may not end up being executed. Find out more at https://expo.dev/privacy-explained{`\n\n`}
